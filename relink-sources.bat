...
(
    echo $sources = Invoke-RestMethod 'http://localhost:8000/api/sources'
    echo if ^($sources.Count -eq 0^) {
    echo     Write-Host '  No footage folders have been added yet.'
    echo     Write-Host '  Open http://localhost:8000 and add a folder under Sources.'
    echo     exit 0
    echo }
...
(
    echo $uri  = 'http://localhost:8000/api/sources/' + $env:FB_ROOT_ID + '/relink'
...
echo  ════════════════════════════════════════════════════════════════════════
echo.
echo  Next step: open http://localhost:8000 and go to Sources.
