...
powershell -NoProfile -Command ^
  "try { $r = Invoke-RestMethod 'http://localhost:8000/health' -TimeoutSec 2; Write-Host '  [OK]   Backend is RUNNING at http://localhost:8000' } catch { Write-Host '  [INFO] Backend is not running  (start with launch-portable.bat)' }" 2>nul
